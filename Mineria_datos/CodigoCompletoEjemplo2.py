...
# se puede decir que la variable region no afecta en nada a la variable objetivo
#se puede ver que con las tres opciones de región, se comporta igual
mosaico_targetbinaria(datos_input['Clasificacion'], varObjBin, 'Clasificacion')
#en cambio, esta si que influye sobre la variable objetivo
